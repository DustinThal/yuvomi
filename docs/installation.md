...
> `2.66.2` (exact version), `2.66` (latest patch of that minor), plus a moving `main`
> tag for the current development state. To pin production to a known-good release,
> set `image: ghcr.io/ulsklyc/yuvomi:2.66.2` in your compose file and bump it
...
>
> ```bash
> cosign verify ghcr.io/ulsklyc/yuvomi:2.66.2 \
...
> image: `docker buildx imagetools inspect ghcr.io/ulsklyc/yuvomi:2.66.2 --format '{{ json .Provenance }}'`.
...
```
yuvomi  | [Yuvomi] Server running on port 3000 | Version 2.66.2
